function [sur,debug] = cobiveco_createClasses(sur, baseNormal, maxAngle, numSubdiv)
    ...
    num_unique_nonbase = numel(unique(nonbase.pointData.RegionId)) 
    ...
    %edit per punti base più precisi
    ids_base_points = vtkMapPointIds(s, base);
    s.pointData.class(ids_base_points) = 1;
