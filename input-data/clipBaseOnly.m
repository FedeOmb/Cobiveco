...
case_name = 'bivMeshFromTorsoKCL1';
...
%% Write result
vtkWrite(sur,  [input_folder case_name '_clipped_sur.vtk']);
vtkWrite(sur,  [output_folder case_name '_clipped.vtp']);
vtkWrite(vol,  [input_folder case_name '_clipped_vol.vtk']);
vtkWrite(vol,  [output_folder case_name '_clipped.vtu']);
