...
input_folder = ['503kaggle500_input' '/'];
output_folder = input_folder;

%% Read original mesh
vol = vtkRead([input_folder '503kaggleclipped500.vtk']);
...
%% Write result
vtkWrite(sur,  [output_folder '503kaggleclipped500_sur.vtk']);
vtkWrite(sur,  [output_folder '503kaggleclipped500_sur.vtp']);
vtkWrite(vol,  [output_folder '503kaggleclipped500_vol.vtk']);
vtkWrite(vol,  [output_folder '503kaggleclipped500_vol.vtu']);

%% export surfaces
outName = '503kaggle500';
